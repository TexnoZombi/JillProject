...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <p class="animation__shake">JILL SHOP</p>
  </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <span class="brand-text font-weight-light">JILL SHOP</span>
    </a>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2024 <a href="{{route('main.index')}}">JILL SHOP</a>.</strong>
    Все права защищены.
...
<script src="{{ asset('adminlte/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.jsphp ') }}"></script>
<!-- AdminLTE App -->
